      ...
      return (
        ...
        <div class="relative bg-white overflow-hidden">
            ...
            <div class="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
                <img class="h-56 w-full object-cover sm:h-72 md:h-96 lg:w-full lg:h-full" src="https://static.rock.so/file/yp8GDyo7/V8lLJao8/3a9a1a58b1daaea25288975b02d88075/kofi_heroimg.png" alt=""/>
            </div>
            </div>
